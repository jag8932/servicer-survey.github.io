...
const SENDER   = 'Your Name <jacobgoodwillie@gmail.com>'; // must be a verified Resend domain
...
async function sendOne({ to, name }) {
  ...
  const { data, error } = await resend.emails.send({
    from:    SENDER,
    to,
    subject: `${name}, Functionality test only, visual request changes to be implemented`,
    html,
  });
